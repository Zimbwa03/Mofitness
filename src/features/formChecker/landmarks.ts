...
export const JOINT_CONNECTIONS: Array<[number, number]> = [
...
export const LANDMARK_NAMES = Object.entries(POSE_LANDMARKS).reduce<Record<number, keyof typeof POSE_LANDMARKS>>(
  (acc, [name, index]) => {
    acc[index] = name as keyof typeof POSE_LANDMARKS;
    return acc;
  },
  {},
);
